...
<body>
    ...
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="admin/user_create.php" class="btn btn-success"><i class="ri-user-add-line me-2"></i>Créer un utilisateur</a>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="admin/user_details.php?id=<?= $user['id'] ?>" class="btn btn-sm btn-info me-1" title="Détails"><i class="ri-eye-line"></i></a>
                                <a href="admin/user_edit.php?id=<?= $user['id'] ?>" class="btn btn-sm btn-warning me-1" title="Éditer"><i class="ri-edit-line"></i></a>
                                <?php if ($user['role'] !== 'admin' || $user['id'] != $auth->getCurrentUser()['id']): ?>
                                <form method="POST" action="admin/user_delete.php" style="display:inline;" onsubmit="return confirm('Supprimer cet utilisateur ?');">
